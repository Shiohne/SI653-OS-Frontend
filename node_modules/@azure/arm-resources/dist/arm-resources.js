...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var Deployments = /** @class */ (function () {
         ...
         */
        Deployments.prototype.deleteAtManagementGroupScope = function (groupId$$1, deploymentName$$1, options) {
            return this.beginDeleteAtManagementGroupScope(groupId$$1, deploymentName$$1, options)
                .then(function (lroPoller) { return lroPoller.pollUntilFinished(); });
        };
        Deployments.prototype.checkExistenceAtManagementGroupScope = function (groupId$$1, deploymentName$$1, options, callback) {
            return this.client.sendOperationRequest({
                groupId: groupId$$1,
         ...
         */
        Deployments.prototype.createOrUpdateAtManagementGroupScope = function (groupId$$1, deploymentName$$1, parameters, options) {
            return this.beginCreateOrUpdateAtManagementGroupScope(groupId$$1, deploymentName$$1, parameters, options)
                .then(function (lroPoller) { return lroPoller.pollUntilFinished(); });
        };
        Deployments.prototype.getAtManagementGroupScope = function (groupId$$1, deploymentName$$1, options, callback) {
            return this.client.sendOperationRequest({
                groupId: groupId$$1,
                deploymentName: deploymentName$$1,
                options: options
        ...
        Deployments.prototype.cancelAtManagementGroupScope = function (groupId$$1, deploymentName$$1, options, callback) {
            return this.client.sendOperationRequest({
                groupId: groupId$$1,
                deploymentName: deploymentName$$1,
                options: options
        ...
        Deployments.prototype.validateAtManagementGroupScope = function (groupId$$1, deploymentName$$1, parameters, options, callback) {
            return this.client.sendOperationRequest({
                groupId: groupId$$1,
                deploymentName: deploymentName$$1,
        ...
        Deployments.prototype.exportTemplateAtManagementGroupScope = function (groupId$$1, deploymentName$$1, options, callback) {
            return this.client.sendOperationRequest({
                groupId: groupId$$1,
                deploymentName: deploymentName$$1,
                options: options
        ...
        Deployments.prototype.listAtManagementGroupScope = function (groupId$$1, options, callback) {
            return this.client.sendOperationRequest({
                groupId: groupId$$1,
                options: options
         ...
         */
        Deployments.prototype.beginDeleteAtManagementGroupScope = function (groupId$$1, deploymentName$$1, options) {
         ...
         * @returns Promise<msRestAzure.LROPoller>
         */
        Deployments.prototype.beginCreateOrUpdateAtManagementGroupScope = function (groupId$$1, deploymentName$$1, parameters, options) {
            return this.client.sendLRORequest({
                groupId: groupId$$1,
                deploymentName: deploymentName$$1,
                parameters: parameters,
        ...
        Deployments.prototype.listAtManagementGroupScopeNext = function (nextPageLink$$1, options, callback) {
            return this.client.sendOperationRequest({
                nextPageLink: nextPageLink$$1,
                options: options
    ...
    var DeploymentOperations = /** @class */ (function () {
        ...
        DeploymentOperations.prototype.getAtManagementGroupScope = function (groupId$$1, deploymentName$$1, operationId$$1, options, callback) {
            return this.client.sendOperationRequest({
                groupId: groupId$$1,
                deploymentName: deploymentName$$1,
        ...
        DeploymentOperations.prototype.listAtManagementGroupScope = function (groupId$$1, deploymentName$$1, options, callback) {
            return this.client.sendOperationRequest({
                groupId: groupId$$1,
                deploymentName: deploymentName$$1,
                options: options
        ...
        DeploymentOperations.prototype.listAtManagementGroupScopeNext = function (nextPageLink$$1, options, callback) {
            return this.client.sendOperationRequest({
                nextPageLink: nextPageLink$$1,
                options: options
